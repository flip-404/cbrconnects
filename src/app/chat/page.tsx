...
const chats = [
  ...
  },
  {
    time: '16:34',
    nickname: '아자차타',
    content: '꼰대전형으로 모들이 남는것도 팀문화로 봤을때는 나쁘지않다고 보는데',
  },
  {
    time: '16:34',
  ...
  },
  {
    time: '16:32',
    nickname: 'Iker_Casillas',
    content: '레알에서 뛸만한 싹인지 아닌지 최소한의 데이터는 확보하고 결론을 내야하는데',
  },
  {
    time: '16:31',
    nickname: 'San Iker',
  ...
  },
  {
    time: '16:28',
    nickname: 'Iker_Casillas',
    content: '애초에 40된 모드리치가 레알급이 아닌데 필요 이상 쓰이고 있는게 문제니까요',
  },
  {
    time: '16:27',
    nickname: 'San Iker',
    content: '그 세바요스도 모드리치 때문에 출장시간 많이 밀렸다가 이제서야 중용 받는 것도 팩트죠',
  },
  {
    time: '16:27',
    nickname: 'Iker_Casillas',
